...
class DaikinSkyport(object):
    ...
    def get_sensors(self, index):
        ...
        sensors.append({"name": f"{name} Indoor heating", "value": round(thermostat['ctIFCHeatRequestedDemandPercent'] / DAIKIN_PERCENT_MULTIPLIER, 1), "type": "demand"})
        sensors.append({"name": f"{name} Indoor heating", "value": round(thermostat['ctIFCCurrentHeatActualStatus'] / DAIKIN_PERCENT_MULTIPLIER, 1), "type": "actual_status"})
